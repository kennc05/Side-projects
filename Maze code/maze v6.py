#CHANGES -V6.0#
#ONLY loops apparently if the player loses
#added a timer
#fixed responses
#all your requests are now done
...
while game_lose_loop:
    ...
    class End(turtle.Turtle):
        ...
        def ended(self):
            ...
            window.bgcolor("white")
            turtle.color("black")
            turtle.write("Congratulations, \n"+playername+" you have reached the end!!!!\nFinal player wealth is: " +(str(player.gold)),  align="center", move=True, font=("Arial",20,"bold"))
            time.sleep(10)
            turtle.clear()
            turtle.home()
            print("Displayed stats of player")
    ...
    with open(filename, "r") as f:
        ...
        #printing the level details to the player on screen
        turtle.clear()
        turtle.penup()
        window.bgcolor("white")
        turtle.color("black")
        print("Displayed level to player")
        turtle.write("...Loaded level "+str(txtfilenumber), align="right", move=True, font=("Arial",20,"bold"))
        time.sleep(2)
        turtle.clear()
        turtle.home()
        window.bgcolor("black")
    ...
    while True:
        ...
        if player.gold<0:
            ...
            turtle.clear()
            turtle.home()
            print("Displayed final wealth of player")
